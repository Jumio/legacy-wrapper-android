...
class NetverifyFragment : Fragment(), View.OnClickListener, NetverifyDeallocationCallback {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		switchOptionTwo?.text =
			resources.getString(R.string.netverify_identity_verification_enabled)
		switchOptionTwo?.isChecked = true
		btnStart?.text = java.lang.String.format(
			resources.getString(R.string.button_start),
			resources.getString(R.string.section_netverify)
		)
